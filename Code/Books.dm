/*
 * Copyright © 2018 RagnarokHGM (Creator/Developer) and Murrawhip (Developer)
...
obj/items/COMCText
	...
	verb
		Read_()
			set src in view(2)
			usr<<browse("<body bgcolor=black><p><p><span style=\"color:white;\"><FONT SIZE=6> <center>Basic COMC Textbook </center> </span><span style=\"color:red;\"><font size=3>Max Quickstaff</span></font> <br><br> <Font size=4> This book is on the few, but powerful spells of COMC, or Care of Magical Creatures.  As you might guess,  this class deals with the various creatures found through out this game. <br><br>The spells: <br><br><Font size=3>Repellium- Kills the closest snake.  You receive no exp for using this spell to kill a snake.  This spell will not work on Summoned Snakes.<br><br>Serpensortia- Summons a snake.  WARNING: Donï¿½t cast this spell in school, and donï¿½t spam it.<br><br>Expecto Patronum- Kills the closest dementor.  You receive no exp for using this spell to kill a dementor.  This spell will not work on summoned Dementors.<br><br>Dementia- Summons a Dementor.  WARNING: Donï¿½t cast this spell in school, and donï¿½t spam it. <p><title>Care of Magical Creatures</title>","window=1")
