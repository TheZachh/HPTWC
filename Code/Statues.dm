...
obj/museum
	...
	Ragnarok HGM
		desc  = "<b>Owner of TWC & Minister of Magic.<b><br>Ragnarok HGM's contributions to TWC excel any other, he will go down forever in history as 'THAT ONE GUY WHO SHUT DOWN TWC BUT THEN CHANGED HIS MIND' and for that reason - we thank him!"
		robes = "MaleStaff"
